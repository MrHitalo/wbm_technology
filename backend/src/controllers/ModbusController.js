...
class ModbusController {
  ...
  static async getTemperatura(req, res) {
    try {
      const dados = await registradorIO.lerTemperatura();
      res.json({
        success: "Sucesso!",
        data: dados,
      });
  ...
  static async getUmidade(req, res) {
    try {
      const dados = await registradorIO.lerUmidade();
      res.json({
        success: "Sucesso!",
        data: dados,
      });
