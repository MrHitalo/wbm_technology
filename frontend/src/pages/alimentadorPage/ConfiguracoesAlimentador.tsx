        ...
        <CardContent className="p-3">
          ...
          <div className="pt-4 flex justify-center">
            <div className="text-sm text-center space-y-2 pb-4">
              <label className="block font-medium text-lg">Id do alimentador</label>
          ...
          <div className="grid grid-cols-2 gap-4 text-lg space-y-3">
            <div className="space-y-1 text-center">
              ...
              <div className="inline-block border-b border-gray-200 px-15 pb-0.5 space-y-1 text-center">08:00</div>
            </div>
            <div className="space-y-1 text-center">
              <label className="block font-medium">HORA DESLIGA CONFIGURADA</label>
              <div className="inline-block border-b border-gray-200 px-15 pb-0.5 space-y-1 text-center">18:00</div>
            </div>
            <div className="space-y-1 text-center">
              <label className="block font-medium">TEMPO CICLO</label>
              <div className="inline-block border-b border-gray-200 px-15 pb-0.5 space-y-1 text-center">15</div>
            </div>
            <div className="space-y-1 text-center">
              <label className="block font-medium">QUANTIDADE POR CICLO(KG)</label>
