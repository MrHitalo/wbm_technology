...
export default function GraficoTemperatura4() {
  ...
  useEffect(() => {
    ...
    const handleData = (data: { temperatura?: { Temperatura_4?: number } }) => {
      if (data.temperatura && typeof data.temperatura.Temperatura_4 !== "undefined") {
        const temperatura = {
          labels: ["Temperatura Atual"],
          datasets: [
            {
              data: [data.temperatura.Temperatura_4, 35 - data.temperatura.Temperatura_4],
  ...
  return (
    <div className="GraficoTemperatura4">
      <h1 className="font-bold text-lg text-center">Temperatura 4</h1>
      {temperatura ? (
