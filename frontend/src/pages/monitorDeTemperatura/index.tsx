                                    ...
                                    <Card className="mt-10">
                                        <CardContent className="p-4 flex flex-col items-center">
                                            <div className="flex flex-col sm:flex-row items-center justify-center gap-50 ">
                                                ...
                                                <h2 className="font-bold text-lg mb-2 text-center">Temperatura 2</h2>
                                                      <Doughnut data={dataTemperatura2} />
                                                </div>
                                                <div className="w-80 h-80">
                                                <h2 className="font-bold text-lg mb-2 text-center">Temperatura 3</h2>
                                                    <Doughnut data={dataTemperatura3} />
                                                </div>
                                            </div>
                                            <div className="w-80 h-80 mb-10">
                                            <h2 className="font-bold text-lg pb-2 text-center">Temperatura 4</h2>
                                                    <Doughnut data={dataTemperatura3} />
                                                </div>
                                        </CardContent>
                                    </Card>
