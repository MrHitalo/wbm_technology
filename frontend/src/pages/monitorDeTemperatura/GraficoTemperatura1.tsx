...
export default function GraficoTemperatura1() {
  ...
  useEffect(() => {
    ...
    const handleData = (data: { temperatura?: { Temperatura_1?: number } }) => {
      if (data.temperatura && typeof data.temperatura.Temperatura_1 !== "undefined") {
        const temperatura = {
          labels: ["Temperatura Atual"],
          datasets: [
            {
              data: [data.temperatura.Temperatura_1, 35 - data.temperatura.Temperatura_1],
