...
export default function GraficoTemperatura3() {
  ...
  useEffect(() => {
    ...
    const handleData = (data: { temperatura?: { Temperatura_3?: number } }) => {
      if (data.temperatura && typeof data.temperatura.Temperatura_3 !== "undefined") {
        const temperatura = {
          labels: ["Temperatura Atual"],
          datasets: [
            {
              data: [data.temperatura.Temperatura_3, 35 - data.temperatura.Temperatura_3],
  ...
  return (
    <div className="GraficoTemperatura3">
      <h1 className="font-bold text-lg text-center">Temperatura 3</h1>
      {temperatura ? (
